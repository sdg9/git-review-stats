...
// const query = `query Something($owner:String!, $name:String!, $count:Int!, $states:[PullRequestState!],$cursor:String) {
//   repository(owner:$owner, name:$name) {
//     pullRequests(last:$count, states:$states,before:$cursor) {
//           totalCount
//           edges {
//             cursor
//             node {
...
//   query: queryNoBody,
// };
// const dataForGit = JSON.stringify(payload);

// console.log(dataForGit);
