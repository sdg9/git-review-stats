...
export default class ProximityGraphView extends D3BaseComponent {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      identityGraph: createIdentityGraph(this.props.nodes, this.props.links),
      graph: null,
    };
  }
  ...
  componentDidMount() {
    ...
    // graph.setSourceData(this.props.nodes, this.props.links);
    graph.setSourceData(this.state.identityGraph);
